...
<template>
  <div class="flex flex-col w-full pt-4 pb-2 min-w-64 nc-sort-create-modal"
    ...
    <div class="flex-col w-full max-h-100 nc-scrollbar-md !overflow-y-auto">
      <div v-if="!options.length"
           class="flex text-gray-500 px-4 py-2.25">{{ $t('general.empty') }}</div>
