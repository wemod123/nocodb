      ...
      <div class="bg-white mt-[60px] relative flex flex-col justify-center gap-2 w-full max-w-[500px] mx-auto p-8 md:(rounded-lg border-1 border-gray-200 shadow-xl)">
        ...
        <a-form ref="formValidator"
          ...
          <template v-if="!appInfo.disableEmailAuth">
            ...
            <a-form-item :label="$t('labels.email')"
                         name="email"
          ...
          <div class="self-center flex flex-col flex-wrap gap-4 items-center mt-4 justify-center">
            <template v-if="!appInfo.disableEmailAuth">
              <button data-testid="nc-form-signin__submit"
            ...
            <a v-if="appInfo.googleAuthEnabled"
            ...
            <div v-if="appInfo.oidcAuthEnabled"
              ...
              <a :href="`${appInfo.ncSiteUrl}/auth/oidc`"
            ...
            <div v-if="!appInfo.inviteOnlySignup"
                 class="text-end prose-sm">
