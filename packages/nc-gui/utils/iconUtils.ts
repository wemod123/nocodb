...
import PhTriangleFill from '~icons/tabler/triangle-filled'
...
import ManytoManySolidIcon from '~icons/nc-icons/mm-solid-1'
import BelongsToSolidIcon from '~icons/nc-icons/bt-solid'
import Record from '~icons/tabler/table-row'
